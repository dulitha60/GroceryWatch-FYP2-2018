...
if(isset($_POST['login_user'])){
	...
	if(count($errors) == 0){
		...
		$query2 = "SELECT * FROM admin WHERE userName='$username' AND password='$password' AND productid='$productid'";
		...
		else if($results2 != FALSE && mysqli_num_rows($results2) == 1){
		    $_SESSION['productid'] = $productid;
			$_SESSION['username'] = $username;
			$_SESSION['success'] = "You are now in admin page";
