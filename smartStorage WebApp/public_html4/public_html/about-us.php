...
<html lang="en">
        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_inner_text">
                    <h2>About Us</h2>
                    <p>All you need to know about smartStorage team</p>
                </div>
            </div>
        </section>
        <!--================End Banner Area =================-->
    ...
    <div class="row">
        <div class="col-md-2 col-xs-2 col-lg-2">
          <h2><font color="#99adff">Abdulrahman</font></h2>
        </div>
        <div class="col-md-2 col-xs-2 col-lg-2">
            <h2><font color="#99adff">Madahwa</font></h2>
        </div>
        <div class="col-md-2 col-xs-2 col-lg-2">
            <h2><font color="#99adff">Imaad</font></h2>
        </div>
        <div class="col-md-2 col-xs-2 col-lg-2">
            <h2><font color="#99adff">Dulitha</font></h2>
        </div>
    </div>
